...
function QuestionBox() {
  ...
  const toggleHighLight = () => {
    document.querySelector('.highOne').classList.add('highLighter');
  };

  const untoggleHighLight = () => {
    document.querySelector('.highOne').classList.remove('highLighter');
  };

  return (
    <div className={isDarkMode ? "dark-mode" : "light-mode"} id="parent">
      <nav className="navbar">
        <div className="logo">
          <div className="left-text">Pop</div>
          ...
          <div className="right-text">uiz</div>
        </div>
        <div
      ...
      {questionState < questions.length ? (
        <div className="box">
          <div className="top">Q{questionState + 1}.</div>
          <div className="bottom">
            <div className="left">
              <div className="left-top">
                <h4 className="highOne">{questions[questionState].text}</h4>
              </div>
              <div className="left-bottom">
                <div className="highlight">
                  <button onClick={toggleHighLight} id="highlight">
                    Highlight
                  </button>
                </div>
                <div className="remove-highlight">
                  <button onClick={untoggleHighLight} id="remove-highlight">
                    Remove Highlight
                  </button>
                </div>
              </div>
